...
(function() {
    var t, e, r, n, i, o, s, a, u, l, h, c, d, _, p, f, g, y, m, v, w, b, D, S, E, I, A, O, R, T, x, C, U, k, L, P, N, F, B, z, j, X, M, V, H, q, W, G, J, K, Z, $, Q, Y, te, ee, re = {}.hasOwnProperty,
        ne = [].indexOf || function(t) {
        ...
        ie = function(t, e) {
            ...
            for (var n in e) re.call(e, n) && (t[n] = e[n]);
    ...
    if (S = function() {
            ...
            function t() {}
            return t
        }(), u = "1.2.0", "undefined" != typeof global && "undefined" != typeof module && "exports" in module) c = global, d = module.require.bind(module), module.exports = S;
    else if ("undefined" != typeof window && "undefined" != typeof navigator) c = window, d = null, window.Dropbox && ! function() {
        var t, e, r, n;
        r = window.Dropbox, n = [];
        for (t in r) re.call(r, t) && (e = r[t], n.push(S[t] = e));
        return n
    }(), window.Dropbox = S;
    else {
    ...
    if (S.Env = function() {
            ...
            function t(t) { this._cancelable = t && t.cancelable, this._listeners = [] }
            ...
            function t(t, e, r) {
                var n, i;
                if (this.method = e, this.url = r, this.status = t.status, t.responseType) try { n = t.response || t.responseText } catch (o) {
                    i = o;
                    try { n = t.responseText } catch (o) { i = o, n = null }
                } else try { n = t.responseText } catch (o) { i = o, n = null }
                if (n) try { this.responseText = n.toString(), this.response = JSON.parse(n) } catch (o) { i = o, this.response = null } else this.responseText = "(no response)", this.response = null
            }
            ...
            if ("undefined" != typeof chrome && chrome.runtime && chrome.runtime.id) return chrome.tabs && chrome.tabs.create ? t.authDriver(new S.AuthDriver.ChromeExtension) : t.authDriver(new S.AuthDriver.ChromeApp), void 0;
            if ("undefined" != typeof window) {
                if (window.cordova) return t.authDriver(new S.AuthDriver.Cordova), void 0;
                window && window.navigator && t.authDriver(new S.AuthDriver.Redirect)
            }
        }, S.AuthDriver.BrowserBase = function() {
            function t(t) { t ? (this.rememberUser = "rememberUser" in t ? t.rememberUser : !0, this.scope = t.scope || "default") : (this.rememberUser = !0, this.scope = "default"), this.storageKey = null, this.storage = S.AuthDriver.BrowserBase.localStorage(), this.stateRe = /^[^#]+\#(.*&)?state=([^&]+)(&|$)/ }
            return t.prototype.authType = function() {
                return "token"
                ...
                var r, n, i, o;
                r = JSON.stringify(t);
                try { this.storage.setItem(this.storageKey, r) } catch (s) { i = s, n = encodeURIComponent(this.storageKey), o = encodeURIComponent(r), document.cookie = "" + n + "=" + o + "; path=/" }
                return e(), this
            }, t.prototype.loadCredentials = function(t) {
                var e, r, n, i, o, s, a;
                try { n = this.storage.getItem(this.storageKey) } catch (u) { a = u, n = null }
                ...
                try { t(JSON.parse(n)) } catch (u) { r = u, t(null) }
                return this
            }, t.prototype.forgetCredentials = function(t) {
                var e, r, n;
                try { this.storage.removeItem(this.storageKey) } catch (i) { n = i, r = encodeURIComponent(this.storageKey), e = new Date(0).toGMTString(), document.cookie = "" + r + "={}; expires=" + e + "; path=/" }
                return t(), this
            ...
            function e(t) { e.__super__.constructor.call(this, t), this.receiverUrl = this.baseUrl(t) }
            ...
            return ie(e, t), e.prototype.url = function() {
                ...
                return r = function(i) {
                    var o, s, a;
                    o = i.data ? i.data : i;
                    try { a = JSON.parse(o)._dropboxjs_oauth_info } catch (u) {
                        return s = u, void 0
                    }
                    if (a) return n.locationStateParam(a) === t ? (t = !1, window.removeEventListener("message", r), S.AuthDriver.Popup.onMessage.removeListener(r), e(S.Util.Oauth.queryParamsFromUrl(o))) : void 0
                ...
                window.addEventListener("load", function() {
                    ...
                    if (o = window.location.href, r = JSON.stringify({ _dropboxjs_oauth_info: o }), S.AuthDriver.BrowserBase.cleanupLocation(), n = window.opener, window.parent !== window.top && (n || (n = window.parent)), n) {
                        try { i = window.location.origin || locationOrigin(o), n.postMessage(r, i), window.close() } catch (s) { e = s }
                        try {
            ...
            function e(t) { e.__super__.constructor.call(this, t), this.storageKey = "dropbox_js_" + this.scope + "_credentials" }
            ...
            function e(t) { e.__super__.constructor.call(this, t), this.receiverUrl = "https://" + chrome.runtime.id + ".chromiumapp.org/" }
            ...
            return ie(e, t), e.prototype.doAuthorize = function(t, e, r, n) {
                ...
                return o = null, i = function(t, r) {
                    var a;
                    if ((!r || !r.tab || r.tab.url.substring(0, s.receiverUrl.length) === s.receiverUrl) && t.dropbox_oauth_receiver_href) return a = t.dropbox_oauth_receiver_href, s.locationStateParam(a) === e ? (e = !1, o && chrome.tabs.remove(o.id), chrome.runtime.onMessage.removeListener(i), n(S.Util.Oauth.queryParamsFromUrl(a))) : void 0
            ...
            function e(t) { e.__super__.constructor.call(this, t) }
            return ie(e, t), e.prototype.url = function() {
            ...
            return t.prototype.onXhr = null, t.prototype.onError = null, t.prototype.onAuthStepChange = null, t.prototype.authDriver = function(t) {
                ...
                if (e || "function" != typeof t || (e = t, t = null), r = t && "interactive" in t ? t.interactive : !0, !this._driver && this.authStep !== h.DONE && (S.AuthDriver.autoConfigure(this), !this._driver)) throw new Error("OAuth driver auto-configuration failed. Call authDriver.");
                if (this.authStep === h.ERROR) throw new Error("Client got in an error state. Call reset() to reuse it!");
                return o = function() {
                    ...
                    var t;
                    if (n !== a.authStep && (n = a.authStep, a._driver && a._driver.onAuthStepChange)) return a._driver.onAuthStepChange(a, s), void 0;
                    switch (a.authStep) {
                        case h.RESET:
                ...
                var r, n, i = this;
                if (e || "function" != typeof t || (e = t, t = null), r = t && t.mustInvalidate, this.authStep !== h.DONE) throw new Error("This client doesn't have a user's token");
                return n = new S.Util.Xhr("POST", this._urls.signOut), n.signWithOauth(this._oauth), this._dispatchXhr(n, function(t) {
                    if (t)
                        if (t.status === S.ApiError.INVALID_TOKEN) t = null;
                ...
                return r || "function" != typeof e || (r = e, e = null), i = {}, n = !1, e && (e.versionTag ? i.rev = e.versionTag : e.rev && (i.rev = e.rev), e.contentHash ? i.hash = e.contentHash : e.hash && (i.hash = e.hash), (e.removed || e.deleted) && (i.include_deleted = "true"), e.readDir && (i.list = "true", e.readDir !== !0 && (i.file_limit = e.readDir.toString())), e.cacheHash && (i.hash = e.cacheHash), e.httpCache && (n = !0)), i.include_deleted || (i.include_deleted = "false"), i.list || (i.list = "false"), o = new S.Util.Xhr("GET", "" + this._urls.metadata + "/" + this._urlEncodePath(t)), o.setParams(i).signWithOauth(this._oauth, n), this._dispatchXhr(o, function(t, e) {
                    ...
                    return o = S.File.Stat.parse(e), n = (null != e ? e.contents : void 0) ? function() {
                        var t, r, n, o;
                        for (n = e.contents, o = [], t = 0, r = n.length; r > t; t++) i = n[t], o.push(S.File.Stat.parse(i));
                        return o
                    }() : void 0, r(t, o, n)
                })
                ...
                return r || "function" != typeof e || (r = e, e = null), i = {}, n = !1, e && (null != e.limit && (i.rev_limit = e.limit), e.httpCache && (n = !0)), o = new S.Util.Xhr("GET", "" + this._urls.revisions + "/" + this._urlEncodePath(t)), o.setParams(i).signWithOauth(this._oauth, n), this._dispatchXhr(o, function(t, e) {
                    ...
                    return i = e ? function() {
                        var t, r, i;
                        for (i = [], t = 0, r = e.length; r > t; t++) n = e[t], i.push(S.File.Stat.parse(n));
                        return i
                    }() : void 0, r(t, i)
                })
                ...
                return n || "function" != typeof r || (n = r, r = null), o = { query: e }, i = !1, r && (null != r.limit && (o.file_limit = r.limit), (r.removed || r.deleted) && (o.include_deleted = !0), r.httpCache && (i = !0)), s = new S.Util.Xhr("GET", "" + this._urls.search + "/" + this._urlEncodePath(t)), s.setParams(o).signWithOauth(this._oauth, i), this._dispatchXhr(s, function(t, e) {
                    ...
                    return i = e ? function() {
                        var t, n, i;
                        for (i = [], t = 0, n = e.length; n > t; t++) r = e[t], i.push(S.File.Stat.parse(r));
                        return i
                    }() : void 0, n(t, i)
                })
                ...
                return r || "function" != typeof e || (r = e, e = null), n = t.cursorTag ? { cursor: t.cursorTag } : { cursor: t }, e && "timeout" in e && (n.timeout = e.timeout), i = new S.Util.Xhr("GET", this._urls.longpollDelta), i.setParams(n), this._dispatchXhr(i, function(t, e) {
                    var n;
                    if ("string" == typeof e) try { e = JSON.parse(e) } catch (i) { n = i, e = null }
            ...
            return t.DATASTORE_SIZE_LIMIT = 10485760, t.RECORD_COUNT_LIMIT = 1e5, t.BASE_DATASTORE_SIZE = 1e3, t.TEAM = "team", t.PUBLIC = "public", t.OWNER = "owner", t.EDITOR = "editor", t.VIEWER = "viewer", t.NONE = "none", t.prototype.recordsChanged = null, t.prototype.syncStatusChanged = null, t.int64 = function(t) {
                var e, r;
                if (Z.is_number(t) && null != t[te.INT64_TAG]) return te.validateInt64(t);
                if (Z.is_string(t)) {
                    if (!te.is_valid_int64_string(t)) throw new Error("Not a valid int64 in string form: " + t);
                    return r = new Number(parseInt(t, 10)), r[te.INT64_TAG] = t, te.validateInt64(r)
                }
                if (!Z.is_number(t) || !isFinite(t)) throw new Error("Not a finite number: " + t);
                if (Number(t) !== Math.round(t)) throw new Error("Number is not an integer: " + t);
                if (e = t.toFixed(), !te.is_valid_int64_string(e)) throw new Error("Number not in int64 range: " + t);
                ...
                var e;
                if (null != t && !Z.string(t)) throw new Error("Title must be a string or null!");
                ...
                if (!this.isShareable()) throw new Error("Datastore is not shareable")
                ...
                if (!this.isWritable()) throw new Error("Datastore is not writable")
            }, t.prototype._checkRole = function(t) {
                if (t !== S.Datastore.EDITOR && t !== S.Datastore.VIEWER) throw new Error("Invalid role: " + t)
            }, t.prototype._checkPrincipal = function(t) {
                if (t !== S.Datastore.TEAM && t !== S.Datastore.PUBLIC && !t.match(/^u[1-9][0-9]*$/)) throw new Error("Invalid principal: " + t)
                ...
                var t, e, r, n, i, o;
                for (this._checkShareable(), r = {}, o = this.getTable(te.ACL_TID).query(), n = 0, i = o.length; i > n; n++) e = o[n], t = e.getId(), r[t] = this._getRole(t);
                return r
                ...
                if (this._checkNotClosed(), !S.Datastore.Table.isValidId(t)) throw new Error("Invalid table ID: " + t);
                ...
                for (s in n)
                    for (r = n[s], a = 0, u = r.length; u > a; a++) e = r[a], Y(s === e._tid, "tid mismatch"), t = !0, o = e._rid, this._managed_datastore.query(s, o) || (e._deleted = !0, this._record_cache.remove(s, o));
            ...
            return r = "arrayOf(" + t + ")", e = function(e, n, i, o) {
                var s, a, u, l, h;
                for (null == i && (i = r), Z.array(e, n, i, o), u = l = 0, h = e.length; h > l; u = ++l) s = e[u], a = function() {
                ...
                var n, i, o, s;
                for (Z.array(e, null, r), s = [], i = 0, o = e.length; o > i; i++) n = e[i], s.push(Z.get_coerce_fn(t)(n));
                return s
            ...
            var e;
            return Z.string(t), Z.check(/^[^].*[$]$/.test(t), "does not start with ^ and end with $", t), e = "does not match regex " + t,
                function(r, n, i, o) {
            ...
            for (i in t) o = t[i], Z.check(Object.prototype.hasOwnProperty.call(t, i), function() {
            ...
            return n = Z.get_coerce_fn(e), i = Z.get_coerce_fn(r), o = function(n, i, o, s) {
                ...
                for (a in n) u = n[a], Z.get_T_fn(e)(a, "property", null, n), Z.get_T_fn(r)(u, function() {
            ...
            var t, e, r;
            r = [];
            for (t in Z) e = Z[t], Z.hasOwnProperty(t) ? r.push(function(t) {
            ...
            for (Z.string(t, "struct name"), Z.array(e, "fields"), f = [], p = {}, s = g = 0, y = e.length; y > g; s = ++g) {
                ...
                for (l in d) "init" !== l && "initFn" !== l && Z.fail("unknown option " + l, d, "field options", "field descrptor", e);
            ...
            return h = "initializer for " + t + " (fields " + function() {
                var t, e, r;
                for (r = [], t = 0, e = f.length; e > t; t++) i = f[t], r.push(i.name);
                return r
            }().join(", ") + ")", n = function(t) {
                var e, r, i;
                Z.defined(t, "x", "initializer");
                for (c in t) e = t[c], t.hasOwnProperty(c) && Z.check(null != p[c], function() {
                    return "has an unexpected field " + c
                }, t, "initializer");
                for (r = 0, i = f.length; i > r; r++) o = f[r], t[o.name] && !t.hasOwnProperty(o.name) && Z.fail("Has an indirect property " + o.name, t, "initializer"), t.hasOwnProperty(o.name) ? (e = t[o.name], this[o.name] = Z.get_coerce_fn(o.type)(e)) : null != o.initFn ? this[o.name] = o.initFn() : Z.fail("lacks the field " + o.name, t, "initializer");
                ...
                for (Z.defined(e, r, i, s), Z.check(e instanceof n, function() {
                    ...
                    }, e, r, i, s), u = 0, l = f.length; l > u; u++) o = f[u], Z.check(e.hasOwnProperty(o.name), function() {
                    return "lacks the field " + o.name
                }, e, r, i, s), Z.get_T_fn(o.type)(e[o.name], o.name, i, s);
                for (c in e) a = e[c], e.hasOwnProperty(c) && Z.check(null != p[c], "has an unexpected field", c, r, i, s);
                return e
            }, n.coerce = function(t) {
                return t instanceof n ? (n.Type(t), t) : new n(t)
            }, n.prototype.toString = function() {
                var t, e, r, n, i;
                for (e = this, t = [], n = 0, i = f.length; i > n; n++) o = f[n], r = e[o.name], t.push("" + o.name + ": " + (Z.is_object(r) && Z.is_function(r.toString) ? r.toString() : JSON.stringify(r)));
                return "{" + t.join(", ") + "}"
            }, n.prototype.toJSON = function() {
                var t, e, r, n;
                for (t = this, e = function() {
                        return "" + t
                    }, r = 0, n = f.length; n > r; r++) o = f[r], Z.get_T_fn(o.type)(this[o.name], o.name, null, e);
                return this
            }, n.fromJSON = function(t) {
                var e, r;
                Z.simple_map(t, "input"), e = {};
                for (l in t) r = t[l], o = p[l], null != o && (_ = o.type, e[l] = null != _.fromJSON ? _.fromJSON(r) : r);
                return new n(e)
            }, n.toString = function() {
                return "struct " + t
            }, n
        }, G = ee.define("StructField", [
            ["name", Z.string],
            ["type", Z.defined],
            ["initFn", Z.defined]
        ]), ee.toJSO = function(t) {
            ...
            if (Z.is_array(t)) return function() {
                var r, n, i;
                for (i = [], r = 0, n = t.length; n > r; r++) e = t[r], i.push(ee.toJSO(e));
                return i
            }();
            n = {};
            for (r in t) i = t[r], t.hasOwnProperty(r) && (n[r] = ee.toJSO(i));
            return n
            ...
            for (Z.string(t, "union name"), Z.array(e, "variants"), n = function() {
                    ...
                    return o = ee.define("" + t + "." + e, i), o.prototype.tag = function() {
                        ...
                        var t, n, i, o, s, a;
                        for (t = [e], s = 0, a = r.length; a > s; s++) n = r[s], i = n[0], o = n[1], Z.get_T_fn(o)(this[i], i), t.push(this[i]);
                        return t
                    }, o.from_array = function(n) {
                        var i, s, a, u, l, h, c;
                        for (l = "initializer for " + t, Z.array(n, "initializer", l), Z.check(n.length === r.length + 1, "does not have length " + (r.length + 1), n, "initializer", l), Z.check(n[0] === e, "does not have tag " + e, n, "initializer", l), i = { _tag: e }, a = h = 0, c = r.length; c > h; a = ++h) s = r[a], u = s[0], i[u] = n[a + 1];
                        return new o(i)
                ...
                }, c = 0, d = e.length; d > c; c++) i = e[c], Z.array(i, "variant", "variant descriptor", e), Z.check(2 === i.length, "does not have length 2", i, "variant descriptor", e), a = Z.string(i[0], "tag", "tag", e), o = Z.array(i[1], "fields", "variant descriptor", e), s = o.slice(0), s.unshift(["_tag", Z.member([a])]), h(a, o, s), u.push(a);
            ...
            if (Z.is_array(t)) {
                for (r = 0, n = t.length; n > r; r++)
                    if (e = t[r], !te.is_atomic_field_value(e)) return !1;
                return !0
            }
            return !1
        ...
        }, te.FieldOp = A = ee.union_as_list("FieldOp", [
            ["P", [
                ["value", te.compound_field_value]
            ]],
            ["D", []],
            ["LC", []],
            ["LP", [
                ["at", Z.uint],
                ["value", te.atomic_field_value]
            ]],
            ["LI", [
                ["before", Z.uint],
                ["value", te.atomic_field_value]
        ...
        ]), te.datadict = Z.simple_typed_map("datadict", Z.field_name, te.compound_field_value), te.update_datadict = Z.simple_typed_map("update_datadict", Z.field_name, A), te.Change = n = ee.union_as_list("Change", [
            ["I", [
                ["tid", Z.tid],
                ["rowid", Z.rowid],
                ["fields", te.datadict]
            ...
            ["U", [
                ["tid", Z.tid],
                ["rowid", Z.rowid],
                ["updates", te.update_datadict]
            ]],
            ["D", [
                ["tid", Z.tid],
                ["rowid", Z.rowid]
            ]]
        ]), te.Delta = D = ee.define("Delta", [
            ["rev", Z.uint],
            ["changes", Z.arrayOf(n)],
            ["nonce", Z.string]
        ]), L = ee.define("ListDatastoresResponseItem", [
            ["dsid", Z.string],
            ["handle", Z.string],
            ["rev", Z.uint],
            ["role", Z.nullable(Z.uint), { init: null }],
            ["info", Z.nullable(te.datadict), { init: null }]
        ]), te.ListDatastoresResponse = k = ee.define("ListDatastoresResponse", [
            ["token", Z.string],
            ["datastores", Z.arrayOf(L)]
        ]), U = ee.define("GetSnapshotResponseRow", [
            ["tid", Z.string],
            ["rowid", Z.string],
            ["data", te.datadict]
            ...
            ["handle", Z.nullable(Z.string), { init: null }],
            ["rev", Z.nullable(Z.uint), { init: null }],
            ["role", Z.nullable(Z.uint), { init: null }],
            ["notfound", Z.nullable(Z.string), { init: null }]
        ]), b = ee.define("DeleteDatastoresResponse", [
            ["ok", Z.string]
        ]), X = ee.define("PutDeltaResponse", [
            ["rev", Z.nullable(Z.uint), { init: null }],
            ["role", Z.nullable(Z.uint), { init: null }],
            ["conflict", Z.nullable(Z.string), { init: null }],
            ["notfound", Z.nullable(Z.string), { init: null }],
            ["access_denied", Z.nullable(Z.string), { init: null }]
        ]), x = ee.define("GetDeltasResponse", [
            ["deltas", Z.nullable(Z.arrayOf(D)), { init: null }],
            ["role", Z.nullable(Z.uint), { init: null }],
            ["notfound", Z.nullable(Z.string), { init: null }]
        ]), e = ee.define("AwaitResponseDeltas", [
            ["deltas", Z.simple_typed_map("deltas map", Z.string, x)]
        ]), te.AwaitResponse = t = ee.define("AwaitResponse", [
            ["get_deltas", Z.nullable(e), { init: null }],
            ["list_datastores", Z.nullable(k), { init: null }]
        ]), r = function() {
            function t() { this.min_delay_millis = 500, this.max_delay_millis = 9e4, this.base = 1.5, this._failures = 0, this.log = !1 }
            return t.prototype.set_log = function(t) { this.log = t }, t.prototype.set_max_delay_millis = function(t) { this.max_delay_millis = t }, t.prototype.get_backoff_millis = function() {
                var t, e;
            ...
            function t(t) { this.client = t, this._retry = new W }
            var e, r;
            ...
            function t(t, e) {
                ...
                for (Z.assert(t.length === e.length, function() {
                    ...
                    }), this.changes = [], this.undo_extras = [], this._last_simple_mtime_update = null, r = n = 0, i = t.length; i >= 0 ? i > n : n > i; r = i >= 0 ? ++n : --n) this.add_change(t[r], e[r])
            }
            var e;
            return e = function(t, e) {
                ...
                switch (t.tag()) {
                    ...
                    case "D":
                        return !1;
                    case "U":
                        if (":info" !== t.tid || "info" !== t.rowid) return !1;
                        if (r = Object.keys(t.updates), 1 !== r.length) return !1;
                        if ("mtime" !== r[0]) return !1;
            ...
            var e, r, n, i;
            if (Z.is_string(t)) return S.Util.countUtf8Bytes(t);
            if (Z.is_bool(t)) return 0;
            if (Z.is_number(t)) return 0;
            if (Z.is_array(t)) {
                for (e = S.Datastore.List.BASE_ITEM_SIZE * t.length, n = 0, i = t.length; i > n; n++) r = t[n], e += te.value_size(r);
                return e
            }
            ...
            return s = function() {
                ...
                switch (e.tag()) {
                    case "I":
                        ...
                        for (r in s) u = s[r], o += S.Datastore.Record.BASE_FIELD_SIZE + te.value_size(u);
                        return o;
                    case "U":
                        i = t.get_record(e.tid, e.rowid), Z.assert(null != i, function() {
                            return "record not found: " + JSON.stringify(e)
                        }), a = 0, l = e.updates;
                        for (r in l) n = l[r], a += te.size_difference_for_field_op(i, r, n);
                        return a;
                    case "D":
            ...
            function t(t, e, r) {
                ...
                for (n in r) i = r[n], this._fields[n] = te.clone(i), this._size += S.Datastore.Record.BASE_FIELD_SIZE + te.value_size(i)
            }
            ...
            function t(t, e) {
                ...
                for (a in e) {
                    ...
                    for (o in i) r = i[o], n = new H(a, o, r), this._check_record_size(t, a, o, n._size), s.put(o, n), this._record_count += 1, this._size += n._size
                }
            ...
            return t.from_get_snapshot_resp = function(e) {
                ...
                for (o in l)
                    for (i = l[o], h = i.list_record_ids(), a = 0, u = h.length; u > a; a++) {
                        ...
                        for (t in c) s = c[t], n += S.Datastore.Record.BASE_FIELD_SIZE + te.value_size(s)
                    }
                return n
                ...
                t = {}, s = this._tables;
                for (n in s)
                    for (r = s[n], t[n] = {}, a = r.list_record_ids(), i = 0, o = a.length; o > i; i++) e = a[i], t[n][e] = te.clone(r.get(e).get_all());
                return t
                ...
                switch (Z.assert(":info" === t.tid, function() {
                    ...
                    case "I":
                        o = t.fields, a = [];
                        for (e in o) n = o[e], a.push(this._changedInfoFields[e] = !0);
                        return a;
                    case "U":
                        s = t.updates, u = [];
                        for (e in s) i = s[e], u.push(this._changedInfoFields[e] = !0);
                        return u;
                    case "D":
                        if (r = this.get_record(":info", "info"), null != r) {
                            l = [];
                            for (e in r.get_all()) l.push(this._changedInfoFields[e] = !0);
                            return l
                        }
                        break;
                    default:
                ...
                for (r in this._changedInfoFields) r in e ? t[r] = e[r] : delete t[r];
                return t
                ...
                try {
                    a = e.updates;
                    for (n in a) i = a[n], s = te.clone(null != (u = t.get(n)) ? u : null), t.apply_field_op(n, i), o[n] = s
                } catch (l) {
                    r = l;
            ...
            function t(t, e, r, n, i, o, s, a) { this.dbid = t, this.handle = e, this.role = r, this.datastore_model = n, this.resolver = i, this.sync_state = o, this.flob_client = s, this._dslist_listener = a, this.syncStateChanged = new S.Util.EventSource, this._deleted = !1, this._open = !0, this._put_delta_queue = new J, this._update_mtime_on_change = !0 }
            return t.fresh_managed_datastore = function(e, r, n, i, o, s, a, u) {
                ...
                var t, e, r, n, i, o;
                for (this.datastore_model.clearInfoFields(), i = this.sync_state.unsynced_deltas, o = [], r = 0, n = i.length; n > r; r++) e = i[r], o.push(function() {
                    var r, n, i, o;
                    for (i = e.changes, o = [], r = 0, n = i.length; n > r; r++) t = i[r], ":info" === t.tid && "info" === t.rowid ? o.push(this.datastore_model.updateInfoFieldsFromChange(t)) : o.push(void 0);
                    return o
                }.call(this));
                return o
                ...
                if (e = function(t) {
                        ...
                        for (e in t)
                            if ("mtime" !== e) return !0;
                        return !1
                    }, ":info" !== t.tid || "info" !== t.rowid) return !1;
                switch (t.tag()) {
                    case "D":
                        if (r = this.datastore_model.get_record(t.tid, t.rowid), null == r) throw new Error("Record not found: " + t.tid + " " + t.rowid);
                        return e(r.get_all());
                    case "U":
                        return e(t.updates);
                    case "I":
                ...
                for (e = {}, s = this.sync_state.unsynced_deltas.slice().reverse(), a = 0, h = s.length; h > a; a++) {
                    for (o = s[a], i = o.inverse_changes(), u = 0, c = i.length; c > u; u++) n = i[u], this.datastore_model.apply_change(!1, n);
                    if (t)
                        for (l = 0, d = i.length; d > l; l++) r = i[l], r.tid in e || (e[r.tid] = {}), e[r.tid][r.rowid] = !0
                }
                return e
            }, t.prototype._do_sync = function() {
                var t, e, r, n, i, o, s, a, u, l, h, c, d, _, p, f, g, y;
                if (o = this.sync_state.get_server_deltas(), 0 === o.length) return {};
                for (i = this.resolver.resolve(this.sync_state.unsynced_deltas, o), n = i.rebased_deltas, t = i.affected_records, s = !1, this._rollback_unsynced_deltas(!1), u = 0, d = o.length; d > u; u++)
                    for (r = o[u], g = r.changes, l = 0, _ = g.length; _ > l; l++) e = g[l], s |= this._should_notify_dslist_listener_for(e), this.datastore_model.apply_change(!1, e);
                for (h = 0, p = n.length; p > h; h++)
                    for (r = n[h], r.undo_extras = [], y = r.changes, c = 0, f = y.length; f > c; c++) e = y[c], s |= this._should_notify_dslist_listener_for(e), a = this.datastore_model.apply_change(!1, e), r.undo_extras.push(a);
                return this.sync_state.update_unsynced_deltas(n), s && this._dslist_listener(), t
            }, t.prototype._do_put_delta = function() {
                var t, e = this;
                if (!this.sync_state.delta_pending() && (t = this.sync_state.get_delta_to_put(), null != t)) return this._put_delta_queue.request(function() {
                ...
                return function() {
                    var e, r, n, i;
                    for (n = this.datastore_model.list_tables(), i = [], e = 0, r = n.length; r > e; e++) t = n[e], ":info" !== t && t !== te.ACL_TID && i.push(t);
                    return i
                }.call(this)
            }, t.prototype.list_rows_for_table = function(t) {
            ...
            function t(t) { this._server_rev = t, Z.uint(this._server_rev, "_server_rev"), this._pending_delta = null, this._server_deltas = [], this.unsynced_deltas = [], this._last_unsynced_delta_unfinalized = !1 }
            return t.prototype.get_server_rev = function() {
                ...
                if (Y(null == this._pending_delta, "delta pending"), n = this.unsynced_deltas.length, !(1 >= n)) {
                    for (s = this._last_unsynced_delta_unfinalized ? this.unsynced_deltas.pop() : null, e = [], o = [], _ = this.unsynced_deltas, a = 0, h = _.length; h > a; a++) {
                        for (r = _[a], p = r.changes, u = 0, c = p.length; c > u; u++) t = p[u], e.push(t);
                        for (f = r.undo_extras, l = 0, d = f.length; d > l; l++) i = f[l], o.push(i)
                    }
            ...
            function t(t) { this.update_manager = t, this.cancelled = !1, this.cancel_fn = null }
            return t.prototype.cancel = function() {
                ...
                return t = function() {
                    var r;
                    if (!e.cancelled) return r = te.clone(e.update_manager._handle_version_map), e.cancel_fn = e.update_manager.flob_client.await(r, e.update_manager._last_dslist_token, function(n, i) {
                        var o, s, a, u, l, h, c, d, _, p;
                        if (e.cancel_fn = null, n) return 0 === n.status ? (console.log("await deltas failed (offline):", n), setTimeout(t, 1e4)) : n.status && 500 <= (d = n.status) && 599 >= d ? (console.log("server error:", n), setTimeout(t, 2e3)) : (console.error("Got error in longpoll:", n), setTimeout(t, 1e4));
                        if (null != i.get_deltas) {
                            _ = i.get_deltas.deltas;
                            for (u in _)
                                if (s = _[u], null != s.notfound) e.update_manager._data_queue.push({ handle: u, notfound: s.notfound }), delete e.update_manager._handle_version_map[u];
                                else if (null != s.deltas) {
                                for (null != s.role && e.update_manager._data_queue.push({ handle: u, role: s.role }), p = s.deltas, h = 0, c = p.length; c > h; h++) a = p[h], e.update_manager._data_queue.push({ handle: u, delta: a });
            ...
            function t(t) { this.flob_client = t, this._data_queue = null, this._handle_version_map = {}, this._last_dslist_token = ".", this._pending_poll = null, this._running = !1 }
            ...
            function t(t, e, r, n) { this.update_manager = t, this.flob_client = e, this._dslist_listener_server = r, this._dslist_listener_local = n, this.update_manager.run(this._handle_server_update.bind(this)), this._cached_objects = {}, this._handle_to_dsid_map = {} }
            return t.prototype.destroy = function() {
                ...
                return function() {
                    ...
                    for (e in r) t = r[e], t.is_deleted() || n.push(e);
                    return n
                }.call(this)
                ...
                var e, r;
                if (!(t in this._cached_objects)) throw new Error("Attempt to close unknown datastore: " + t);
            ...
            function t(t) {
                ...
                for (m = ["P", "D"], a = 0, c = m.length; c > a; a++)
                    for (o = m[a], l = 0, d = e.length; d > l; l++) i = e[l], this._transforms[o][i] = p, this._transforms[i][o] = f;
                for (y = 0, _ = e.length; _ > y; y++) i = e[y], "LC" === i ? this._transforms.LC.LC = function() {
                    return [null, null]
            ...
            for (g = function(t) {
                ...
                }, i = ["null", "bool", "num", "str", "blob", "ts", "list"], o = {}, h = m = 0, v = i.length; v > m; h = ++m) y = i[h], o[y] = h;
            return l = function(t) {
                if (null == t) return "null";
                if (Z.is_bool(t)) return "bool";
                if (null != t.I || Z.is_number(t)) return "num";
                if (Z.is_string(t)) return "str";
                if (null != t.B) return "blob";
                if (null != t.T) return "ts";
                if (Z.is_array(t)) return "list";
                ...
                if ("num" === r) return null != t.I && null != e.I ? te.int64_string_less_than(t.I, e.I) : s(t) < s(e);
                if ("str" === r) return e > t;
                if ("blob" === r) return t.B < e.B;
                if ("ts" === r) return parseInt(t.T, 10) < parseInt(e.T, 10);
                if ("list" === r) return d(t, e);
            ...
            function t() { this._transform_rules = {}, this._default_transformer = new O }
            var e, r, i, o, s, a, u, l;
            for (e = {}, l = ["default", "local", "remote", "min", "max", "sum"], a = 0, u = l.length; u > a; a++) i = l[a], e[i] = new O(i);
            return s = function(t) {
                return Y(null != t),
                    function(e, r) {
                        var n, i, o;
                ...
                return o(t, e) ? (i = function(t) {
                    var e, i, o, s, a;
                    o = {}, a = t.fields;
                    for (i in a) s = a[i], o[i] = A.from_array(["P", r(s)]);
                ...
                for (s in m) r = m[s], s in e.updates ? (i = e.updates[s], p = null != (w = t.undo_extra[s]) ? w : null, f = this.get_field_transformer(t.tid, s), b = f.transform(r, i, p), a = b[0], u = b[1], g = b[2], null != a && (d[s] = a, c[s] = null != g ? g : null), null != u && (_[s] = u)) : (d[s] = r, c[s] = null != (v = t.undo_extra[s]) ? v : null);
                D = e.updates;
                for (s in D) i = D[s], s in t.updates || (_[s] = i);
                return l = n.from_array(["U", t.tid, t.rowid, d]), l.undo_extra = c, h = n.from_array(["U", e.tid, e.rowid, _]), [
                    [l],
                    [h]
                ]
            ...
            function t() { this._change_transformer = new i }
            return t.prototype.add_resolution_rule = function(t, e, r) {
                ...
                for (r = t[0], n = e[0], _ = this._transform_one(r, n), o = _[0], s = _[1], p = this._transform_list(t.slice(1), s), i = p[0], s = p[1], l = 0, c = i.length; c > l; l++) a = i[l], o.push(a);
                for (f = this._transform_list(o, e.slice(1)), o = f[0], u = f[1], h = 0, d = u.length; d > h; h++) a = u[h], s.push(a);
                return [o, s]
                ...
                for (d = [], y = 0, b = t.length; b > y; y++) {
                    for (h = t[y], i = [], C = h.changes, c = m = 0, D = C.length; D > m; c = ++m) s = C[c], u = n.from_array(JSON.parse(JSON.stringify(s))), u.undo_extra = te.clone(h.undo_extras[c]), i.push(u);
                    d.push(i)
                }
                for (f = [], v = 0, S = e.length; S > v; v++)
                    for (h = e[v], U = h.changes, w = 0, E = U.length; E > w; w++) o = U[w], f.push(o);
                for (k = this._resolve(d, f), _ = k[0], l = k[1], p = [], c = R = 0, I = _.length; I > R; c = ++R) {
                    for (a = _[c], g = function() {
                            var t, e, r;
                            for (r = [], e = 0, t = a.length; t > e; e++) s = a[e], r.push(null);
                            return r
                        }(), T = 0, A = a.length; A > T; T++) s = a[T], delete s.undo_extra;
                    a.length > 0 && p.push(new P(a, g))
                }
                for (r = {}, x = 0, O = l.length; O > x; x++) o = l[x], o.tid in r || (r[o.tid] = {}), r[o.tid][o.rowid] = !0;
                return { rebased_deltas: p, affected_records: r }
            }, t
        }(), te.DefaultResolver = w, J = function() {
            function t() { this._waiting = [], this._running = !1 }
            ...
            function t(t) { this.consumer = t, this.items = [], this.sync_queue = new J }
            ...
            if (t instanceof Array) {
                for (a = [], o = 0, s = t.length; s > o; o++) e = t[o], a.push(te.clone(e));
                return a
            }
            if (null != t && "object" == typeof t) {
                n = {};
                for (r in t) i = t[r], n[r] = te.clone(i);
                return n
            }
            return t
            ...
            return function() {
                var r, n;
                for (n = [], e = r = 0; t >= 0 ? t > r : r > t; e = t >= 0 ? ++r : --r) n.push(te.randomElement(te.WEB64_ALPHABET));
                return n
            }().join("")
        }, te.uint8ArrayFromBase64String = function(t) {
            var e, r, n, i, o;
            for (t = t.replace(/-/g, "+").replace(/_/g, "/"), e = S.Util.atob(t), n = e.length, i = new Uint8Array(n), r = o = 0; n >= 0 ? n > o : o > n; r = n >= 0 ? ++o : --o) i[r] = e.charCodeAt(r);
            return i
            ...
            if (r = t[te.INT64_TAG], !Z.is_string(r) || "0" !== r && !te.nonzero_int64_approximate_regex.test(r)) throw new Error("Missing or invalid tag in int64: " + r);
            ...
            if (Z.is_string(t)) return t;
            if (Z.is_bool(t)) return t;
            if (Z.is_number(t)) {
                if (null != t[te.INT64_TAG]) return te.validateInt64(t), { I: t[te.INT64_TAG] };
            ...
            if (Z.is_array(t)) {
                if (e) return function() {
                    var e, r, i;
                    for (i = [], e = 0, r = t.length; r > e; e++) n = t[e], i.push(te.toDsValue(n, !1));
                    return i
                }();
                throw new Error("Nested array not allowed: " + JSON.stringify(t))
            }
            if (Z.is_date(t)) return r = Math.round(t.getTime()), { T: "" + r };
            if (Z.isUint8Array(t)) return { B: te.base64StringFromUint8Array(t) };
            throw new Error("Unexpected value: " + Z.safe_to_string(t))
        }, te.fromDsValue = function(t, e, r, n) {
            if (Z.is_string(n)) return n;
            if (Z.is_bool(n)) return n;
            if (Z.is_number(n)) return n;
            if (Z.is_array(n)) return new S.Datastore.List(t, e, r);
            if ("object" != typeof n) throw new Error("Unexpected value: " + n);
            if (null != n.I) return S.Datastore.int64(n.I);
            if (null == n.N) {
                if (null != n.B) return te.uint8ArrayFromBase64String(n.B);
            ...
            n = function(t, e) {
                ...
                var r, i, o, s, a, u;
                if (te.toDsValue(t), Z.is_string(t) && Z.is_string(e)) return String(t) === String(e);
                if (Z.is_bool(t) && Z.is_bool(e)) return "object" == typeof t && (t = t.valueOf()), "object" == typeof e && (e = e.valueOf()), Boolean(t) === Boolean(e);
                if (Z.is_number(t) && (Z.is_number(e) || null != e.N || null != e.I)) return e = te.fromDsValue(void 0, void 0, void 0, e), t[te.INT64_TAG] && e[te.INT64_TAG] ? (s = [S.Datastore.int64(t), S.Datastore.int64(e)], t = s[0], e = s[1], String(t[te.INT64_TAG]) === String(e[te.INT64_TAG])) : isNaN(t) && isNaN(e) ? !0 : Number(t) === Number(e);
                ...
                if (Z.is_date(t) && (Z.is_date(e) || null != e.T)) return null != e.T && (e = te.fromDsValue(void 0, void 0, void 0, e)), t - 0 === e - 0;
                if (Z.isUint8Array(t) && (Z.isUint8Array(e) || null != e.B)) {
                    if (null != e.B && (e = te.fromDsValue(void 0, void 0, void 0, e)), t.length !== e.length) return !1;
            ...
            function t(t) { this._datastore = t, this._cache = {} }
            ...
            function t() { this._registered_handlers = [] }
            ...
            function t(t, e, r, n) { this._dsid = t, this._handle = e, this._info_record_data = r, this._role = n }
            ...
            function e(t) { this.options = t, e.__super__.constructor.call(this, t), this._have_event = !1, this._last_event = null, this._listenersChanged = new S.Util.EventSource }
            ...
            return t.prototype.datastoreListChanged = null, t.prototype.close = function() {
                ...
                for (n in o) l = o[n], o[n] = Z.is_array(l) ? function() {
                    var t, e, r;
                    for (r = [], t = 0, e = l.length; e > t; t++) u = l[t], r.push(te.fromDsValue(null, null, null, u));
                    return r
                ...
                for (k.Type(t), e = this._obj_manager.getAllCachedUndeletedDatastoreIDs(), s = {}, a = 0, l = e.length; l > a; a++) i = e[a], s[i] = null;
                for (c = t.datastores, u = 0, h = c.length; h > u; u++) n = c[u], s[n.dsid] = n;
                return function() {
                    var t;
                    t = [];
                    for (o in s) r = s[o], t.push(this._getOverlaidDatastoreInfo(o, r));
                    return t
                }.call(this)
            ...
            function t(t, e, r) { this._datastore = t, this._record = e, this._field = r }
            return t.BASE_ITEM_SIZE = 20, t.prototype.toString = function() {
                ...
                if (this._record._checkNotDeleted(), !Z.is_array(this._array())) throw new Error("Attempt to operate on deleted list (" + this._record._tid + ", " + this._record._rid + ", " + this._field + ")")
                ...
                var e, r;
                if (!Z.is_json_number(t)) throw new RangeError("Index not a number: " + t);
                ...
                var t, e, r, n, i, o, s, a, u;
                if (n = arguments[0], e = arguments[1], t = 3 <= arguments.length ? oe.call(arguments, 2) : [], this._checkValid(), !Z.is_json_number(e) || 0 > e) throw new RangeError("Bad second arg to splice: " + n + ", " + e);
                ...
                return this._checkValid(),
                    function() {
                        var n, i, o, s;
                        for (o = this._array().slice(t, e), s = [], n = 0, i = o.length; i > n; n++) r = o[n], s.push(te.fromDsValue(void 0, void 0, void 0, r));
                        return s
                    }.call(this)
                ...
                return this._checkValid(),
                    function() {
                        var e, r, n, i;
                        for (n = this._array().slice(), i = [], e = 0, r = n.length; r > e; e++) t = n[e], i.push(te.fromDsValue(void 0, void 0, void 0, t));
                        return i
                    }.call(this)
            }, t
        }(), S.Datastore.Record = function() {
            function t(t, e, r) { this._datastore = t, this._tid = e, this._rid = r, this._deleted = !1, this._record_cache = this._datastore._record_cache, this._managed_datastore = this._datastore._managed_datastore }
            return t.RECORD_SIZE_LIMIT = 102400, t.BASE_RECORD_SIZE = 100, t.BASE_FIELD_SIZE = 100, t.prototype.get = function(t) {
                ...
                else if (!Z.is_array(r[t])) throw new Error("Can't call getOrCreateList on field " + t + " for record (" + this.tid + ", " + this.rid + "): existing value " + r[t] + " is not a list");
                ...
                for (e in n) r = n[e], t[e] = te.fromDsValue(this._datastore, this, e, r);
                return t
            }, t.prototype.getSize = function() {
                ...
                for (r in t) n = t[r], null != n ? e[r] = ["P", te.toDsValue(n)] : null != this.get(r) && (e[r] = ["D"]);
            ...
            function t(t, e) { this._recordsByTable = t, this._local = e }
            return t.prototype.toString = function() {
                var t, e, r, n, i, o, s;
            ...
            function t(t, e) { this._datastore = t, this._tid = e, this._record_cache = this._datastore._record_cache, this._managed_datastore = this._datastore._managed_datastore }
            return t.prototype.getId = function() {
                return this._tid
            }, t.prototype.get = function(t) {
                var e, r;
                if (!S.Datastore.Record.isValidId(t)) throw new Error("Invalid record ID: " + t);
                ...
                var e, r, n, i, o, s, a;
                for (o = this._managed_datastore.list_rows_for_table(this._tid), n = [], s = 0, a = o.length; a > s; s++) i = o[s], e = this._managed_datastore.query(this._tid, i), (null == t || te.matchDsValues(t, e)) && (r = this.get(i), Y(null != r), n.push(r));
                return n
                ...
                var r, i, o, s, a;
                i = {};
                for (o in e) a = e[o], i[o] = te.toDsValue(a);
            ...
            function t(t, e) { this.url = t.url, this.expiresAt = S.Util.parseDate(t.expires), this.isDirect = e === !0 ? !0 : e === !1 ? !1 : "direct" in t ? t.direct : Date.now() - this.expiresAt <= 864e5, this.isPreview = !this.isDirect, this._json = null }
            ...
            function t(t) { "object" == typeof t ? (this.tag = t.copy_ref, this.expiresAt = S.Util.parseDate(t.expires), this._json = t) : (this.tag = t, this.expiresAt = new Date(1e3 * Math.ceil(Date.now() / 1e3)), this._json = null) }
            return t.parse = function(t) {
            ...
            function t(t) {
                ...
                this.blankSlate = t.reset || !1, this.cursorTag = t.cursor, this.shouldPullAgain = t.has_more, this.shouldBackOff = !this.shouldPullAgain, this.changes = t.cursor && t.cursor.length ? function() {
                    var r, n, i, o;
                    for (i = t.entries, o = [], r = 0, n = i.length; n > r; r++) e = i[r], o.push(S.Http.PulledChange.parse(e));
                    return o
                }() : []
            }
            return t.parse = function(t) {
            ...
            function t(t) { this.path = t[0], this.stat = S.File.Stat.parse(t[1]), this.stat ? this.wasRemoved = !1 : (this.stat = null, this.wasRemoved = !0) }
            return t.parse = function(t) {
            ...
            function t(t) { this.hasChanges = t.changes, this.retryAfter = t.backoff || 0 }
            return t.parse = function(t) {
            ...
            return r = function(t, e, r, n) {
                    ...
                    for (t[e >> 2] |= 1 << 31 - ((3 & e) << 3), t[(e + 8 >> 6 << 4) + 15] = e << 3, g = Array(80), r = 1732584193, i = 4023233417, s = 2562383102, u = 271733878, h = 3285377520, d = 0, p = t.length; p > d;) {
                        for (n = r, o = i, a = s, l = u, c = h, _ = m = 0; 80 > m; _ = ++m) 16 > _ ? g[_] = 0 | t[d + _ << 2 >> 2] : (f = (0 | g[_ - 3 << 2 >> 2]) ^ (0 | g[_ - 8 << 2 >> 2]) ^ (0 | g[_ - 14 << 2 >> 2]) ^ (0 | g[_ - 16 << 2 >> 2]), g[_] = f << 1 | f >>> 31), y = 0 | (0 | (r << 5 | r >>> 27) + h) + g[_ << 2 >> 2], y = 20 > _ ? 0 | y + (0 | (i & s | ~i & u) + 1518500249) : 40 > _ ? 0 | y + (0 | (i ^ s ^ u) + 1859775393) : 60 > _ ? 0 | (0 | y + ((i & s | i & u | s & u) - 1894007588)) : 0 | y + (0 | (i ^ s ^ u) - 899497514), h = u, u = s, s = i << 30 | i >>> 2, i = r, r = y;
                    ...
                    for (t[e >> 2] |= 1 << 31 - ((3 & e) << 3), t[(e + 8 >> 6 << 4) + 15] = e << 3, U = Array(80), r = s[0], i = s[1], u = s[2], c = s[3], _ = s[4], f = s[5], y = s[6], S = s[7], I = 0, O = t.length; O > I;) {
                        for (n = r, o = i, l = u, d = c, p = _, g = f, m = y, E = S, A = P = 0; 64 > P; A = ++P) 16 > A ? C = U[A] = 0 | t[I + A << 2 >> 2] : (w = 0 | U[A - 15 << 2 >> 2], v = (w << 25 | w >>> 7) ^ (w << 14 | w >>> 18) ^ w >>> 3, D = 0 | U[A - 2 << 2 >> 2], b = (D << 15 | D >>> 17) ^ (D << 13 | D >>> 19) ^ D >>> 10, C = U[A] = 0 | (0 | v + (0 | U[A - 7 << 2 >> 2])) + (0 | b + (0 | U[A - 16 << 2 >> 2]))), h = _ & f ^ ~_ & y, R = r & i ^ r & u ^ i & u, T = (r << 30 | r >>> 2) ^ (r << 19 | r >>> 13) ^ (r << 10 | r >>> 22), x = (_ << 26 | _ >>> 6) ^ (_ << 21 | _ >>> 11) ^ (_ << 7 | _ >>> 25), k = 0 | (0 | (0 | S + x) + (0 | h + C)) + (0 | a[A << 2 >> 2]), L = 0 | T + R, S = y, y = f, f = _, _ = 0 | c + k, c = u, u = i, i = r, r = 0 | k + L;
            ...
            function t(t) { this._id = null, this._secret = null, this._stateParam = null, this._authCode = null, this._token = null, this._tokenKey = null, this._tokenKid = null, this._error = null, this._appHash = null, this._loaded = null, this.setCredentials(t) }
            ...
            var e, r, n, i, o;
            for (e = 0, n = i = 0, o = t.length; o >= 0 ? o > i : i > o; n = o >= 0 ? ++i : --i) r = t.charCodeAt(n), 127 >= r ? e += 1 : 2047 >= r ? e += 2 : r >= 55296 && 57343 >= r ? e += 2 : 65535 >= r ? e += 3 : Y(!1);
            return e
        ...
        if (Object.getPrototypeOf ? _ = Object.getPrototypeOf(Object.getPrototypeOf(new Uint8Array(0))).constructor : Object.__proto__ && (_ = new Uint8Array(0).__proto__.__proto__.constructor), S.Env.global.Blob) {
            ...
            } catch (se) { m = !1, v = !1, S.Env.global.WebKitBlobBuilder && -1 !== navigator.userAgent.indexOf("Android") && (p = !1) }
            _ === Object && (m = !1)
        } else v = !1, m = !0;
    else _ = null, v = !1, m = !1;
    S.Util.Xhr = function() {
            function t(t, e) { this.method = t, this.isGet = "GET" === this.method, this.url = e, this.wantHeaders = !1, this.headers = {}, this.params = null, this.body = null, this.preflight = !(this.isGet || "POST" === this.method), this.signed = !1, this.completed = !1, this.responseType = null, this.callback = null, this.xhr = null, this.onError = null }
            return t.Request = y, t.ieXdr = g, t.canSendForms = p, t.doesPreflight = f, t.ArrayBufferView = _, t.sendArrayBufferView = m, t.wrapBlob = v, t.prototype.xhr = null, t.prototype.onError = null, t.prototype.setParams = function(t) {
                ...
                if ("object" == typeof r) {
                    ...
                    try { r = new Blob([r], { type: n }) } catch (l) { o = l, window.WebKitBlobBuilder && (a = new WebKitBlobBuilder, a.append(r), (i = a.getBlob(n)) && (r = i)) }
                ...
                if (e = S.Util.Xhr.ieXdr, this.isGet || null !== this.body || e ? (this.paramsToUrl(), null !== this.body && "string" == typeof this.body && (this.headers["Content-Type"] = "text/plain; charset=utf8")) : this.paramsToBody(), this.xhr = new S.Util.Xhr.Request, e ? (this.xhr.onload = function() {
                    ...
                    n = this.headers;
                    for (t in n) re.call(n, t) && (r = n[t], this.xhr.setRequestHeader(t, r))
                }
                ...
                if (this.callback = t || this.callback, null !== this.body) {
                    ...
                    try { this.xhr.send(e) } catch (n) {
                        if (r = n, S.Util.Xhr.sendArrayBufferView || !S.Util.Xhr.wrapBlob) throw r;
                ...
                if (this.completed = !0, this.xhr.status < 200 || this.xhr.status >= 300) return e = new S.ApiError(this.xhr, this.method, this.url), this.onError ? this.onError(e, this.callback) : this.callback(e), !0;
                if (this.wantHeaders ? (t = this.xhr.getAllResponseHeaders(), s = t ? S.Util.Xhr.parseResponseHeaders(t) : this.guessResponseHeaders(), h = s["x-dropbox-metadata"]) : (s = void 0, h = this.xhr.getResponseHeader("x-dropbox-metadata")), null != h ? h.length : void 0) try { l = JSON.parse(h) } catch (f) {
                    if (u = f, o = h.search(/\}\,\s*\{/), -1 !== o) try { h = h.substring(0, o + 1), l = JSON.parse(h) } catch (f) { u = f, l = void 0 } else l = void 0
                } else l = void 0;
                if (this.responseType) {
                    if ("b" === this.responseType) {
                        for (i = null != this.xhr.responseText ? this.xhr.responseText : this.xhr.response, r = [], a = _ = 0, p = i.length; p >= 0 ? p > _ : _ > p; a = p >= 0 ? ++_ : --_) r.push(String.fromCharCode(255 & i.charCodeAt(a)));
        ...
        }(), Q = "X-Dropbox-User-Agent", M = "X-Dropbox-Request-Id", S.DatastoresClient = {
        ...
        function() {
            ...
            for (e in r) t = r[e], n.push(S.Client.prototype[e] = t);
            return n
        }()
}).call(this);
